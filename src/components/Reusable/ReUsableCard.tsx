  ...
  return (
    <div className="bg-white rounded-lg p-4 shadow-sm border min-w-[350px] max-w-[400px] border-gray-200">
      ...
      <div className="flex gap-2 items-center mb-4">
        ...
        <div className="relative text-start flex-1">
          <h3 className="text-lg font-semibold text-gray-800 flex items-center relative">
            {name}
            <div className={`ml-1 w-4 h-4 absolute top-0 -left-5 z-10 ${verifiedColor}`}>
              <svg
                fill="currentColor"
                viewBox="0 0 20 20"
          ...
          <div className="flex bg-[#FDEAD7] rounded-[100px] p-[2px] w-[56px] items-center text-xs text-gray-600 mt-1">
