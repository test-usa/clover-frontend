import { otpVerifyApi } from "@/store/api/authApi";
...
const OTP: React.FC = () => {
  ...
  // Assuming you have a user in your Redux store
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      const res = await otpVerifyApi(user._id, otpdata);
